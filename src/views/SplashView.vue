<template>
  <div
    class="flex items-center justify-center absolute z-50 bg-white text-black dark:bg-zinc-950 dark:text-slate-300 text-center w-screen h-screen"
  >
    <div>
      ...
      <p
        :class="[
          ...
          status ? 'text-green-600' : 'text-black dark:text-slate-300',
        ]"
      >
        {{ message }}
      </p>
